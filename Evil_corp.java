...
public class Evil_corp {
	...
	final static int[] vPR = new int[] {65,54,19,98,168,33,110,187,244,22,204,4,127,100,232,93,
			...
			38,74,107,152,250,234,119,83,178,112,5,44,253,89,58,134,126,
	...
	final static int[] vPI = new int[] {71,241,180,230,11,106,114,72,133,78,158,235,226,248,148,83,
	...
	final static int[] vPS = new int[] {20,83,15,86,179,200,122,156,235,101,72,23,22,21,159,2,
	...
	public static void main (String args[]){
		...
		for (int num_clave = 0; num_clave < 4; num_clave++) {
			...
			int [] ascii =  new int[3];
			//Cogemos la cadena de caracteres y la pasaos a un array con sus correspondientes valores en la tabla ascii
			for (int j = 0; j < frase.length(); j++) {
				char character = frase.charAt(j); 
				ascii [j] = (int) character; 
			}
			

			ofuscar(ascii, num_clave);
			//Convertimos de nuevo a su corresondiente carcter en la tabla ascii
	...
	public static void ofuscar (int [] txt, int clave){
	...
	for (int i = 0; i < txt.length; i++) { // Recorre el vector txt
		...
		txt[i] = b; 	//System.out.println(txt[i]);
